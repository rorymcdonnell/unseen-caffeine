    ...
    <Router>
      ...
      <main className="py-3">
        <Container>
          ...
          <Route path="/shop" component={CoffeeProducts} exact />
          <Route path="/merchandise" component={MerchandiseProducts} exact />
          <Route path="/subscriptions" component={SubscriptionScreen} exact />
          <Route path="/subscription/:id" component={SubscriptionItem} exact />
          <Route
            path="/checkout"
          ...
          <Route path="/subscriptionlist" component={SubscriptionListScreen} />
